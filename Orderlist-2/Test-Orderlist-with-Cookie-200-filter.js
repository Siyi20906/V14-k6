...
let orderlist_time= new Trend('orderlist_time');
...
let timeout = 120000;
  ...
  //orderlist
  //var url = 'http://' + host + '/ApemMobile/servlet/mobileOrderListServlet?tz=UTC&states=0&init=0&num=200';
  var url = 'http://' + host + '/ApemMobile/servlet/mobileOrderListServlet?tz=UTC&states=0%7C1%7C2%7C3%7C4&init=0&num=200';
  let data = {};
  start = Date.now();
