...
export let options = {
    // vus:5
    stages: [
      { duration: '100s', target: 20 }, //ramp up 2 user 5 min
      { duration:'20m', target: 20 } //duration of run
    ],
};
...
//Get ID_Oper
  ...
  //select an area
  start = Date.now();
  url = 'http://' + host + '/ApemMobile/servlet/mobileExecutionServlet?tz=America%252FLos_Angeles&vmName=' + vmname + '&action=3&targetComp=ORDER_STATUS.CmbArea&targetCompValue=COMPOUNDING&sourceComp=ORDER_STATUS.CmbArea&sourceCompValue=';
  //console.log(url)
  data = {};
  res = http.post(url, JSON.stringify(data),
    {
  ...
  url = 'http://' + host + '/ApemMobile/servlet/mobileExecutionServlet?tz=America%252FLos_Angeles&vmName=' + vmname + '&action=3&targetComp=ORDER_STATUS.cmbProductDescription&targetCompValue=&sourceComp=ORDER_STATUS.ChkArea&sourceCompValue=';
  //console.log(url)
  data = {};
  res = http.post(url, JSON.stringify(data),
    {
  ...
  //select an product
  start = Date.now();
  url = 'http://' + host + '/ApemMobile/servlet/mobileExecutionServlet?tz=America%252FLos_Angeles&vmName=' + vmname + '&action=3&targetComp=ORDER_STATUS.cmbProductDescription&targetCompValue=Aspeglical%20800&sourceComp=ORDER_STATUS.cmbProductDescription&sourceCompValue=';
  //console.log(url)
  data = {};
  res = http.post(url, JSON.stringify(data),
    {
  ...
  url = 'http://' + host + '/ApemMobile/servlet/mobileExecutionServlet?tz=America%252FLos_Angeles&vmName=' + vmname + '&action=3&targetComp=ORDER_STATUS.CmbProductionLine&targetCompValue=&sourceComp=ORDER_STATUS.cmbProductDescription&sourceCompValue=';
  //console.log(url)
  data = {};
  res = http.post(url, JSON.stringify(data),
    {
  ...
  //select productline
  start = Date.now();
  url = 'http://' + host + '/ApemMobile/servlet/mobileExecutionServlet?tz=America%252FLos_Angeles&vmName=' + vmname + '&action=3&targetComp=ORDER_STATUS.CmbProductionLine&targetCompValue=First%20Compounding%20Line&sourceComp=ORDER_STATUS.CmbProductionLine&sourceCompValue=';
  //console.log(url)
  data = {};
  res = http.post(url, JSON.stringify(data),
    {
